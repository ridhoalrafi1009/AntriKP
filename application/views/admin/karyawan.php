								...
								<table class="table table-bordered">
									...
									?>
										<tr style="text-align:center;">
											...
											<td><a href="#<?php echo $row->username; ?>" class="btn btn-success btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i></a>&nbsp;<a href="<?php echo site_url('admin/del_karyawan/' . $row->username); ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a></td>
										</tr>
